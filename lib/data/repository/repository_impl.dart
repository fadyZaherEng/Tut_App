...
import 'package:flutter_cleanarchi_with_mvvm_finished/data/mapper/mapper.dart';
...
class RepositoryImpl implements Repository {
  ...
  @override
  Future<Either<Failure, HomeStoreNotNull>> getHomeStoreDetails() async{
    try {
      // get response from cache
      ...
      if (await _networkInfo.isConnected) {
        // its connected to internet, its safe to call API
        try {
          final response = await _remoteDataSource.getHomeStoreDetailsData();
          if (response.status == ApiInternalStatus.SUCCESS) {
            // success
            // return either right
            // return data
